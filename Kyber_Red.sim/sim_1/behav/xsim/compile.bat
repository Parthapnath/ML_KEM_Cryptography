...
REM
REM Generated by Vivado on Tue Sep 22 00:16:55 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_reduction_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_reduction_vlog.prj -log xvlog.log
